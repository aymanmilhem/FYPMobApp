...
namespace GreenWorld.Models
{
    ...
    public partial class RecordTasksPage : ContentPage
    {
        public IList<Tip> Tips { get; private set; }

        public RecordTasksPage()
        {
            InitializeComponent();
            ...
            {
                Title = "Eat Less Meat",
                Text = "Although it might sound unrelated, eating Less meat can affect the environment tremendously. ",
                ImageUrl = "vegetables",
